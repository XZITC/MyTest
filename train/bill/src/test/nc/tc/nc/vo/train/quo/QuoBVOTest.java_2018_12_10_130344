...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class QuoBVOTest extends BaseTestCase {
  QuoBVO quoBVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    quoBVO=NCLocator.getInstance().lookup(QuoBVO.class);
  }
  ...
  public void getPk_quo_b(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=quoBVO.getPk_quo_b();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_quo_b(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_quo_b=(String)dp.get("pk_quo_b").get(0);
    
    //Invoke tested method
    quoBVO.setPk_quo_b(pk_quo_b);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_material(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=quoBVO.getPk_material();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_material(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_material=(String)dp.get("pk_material").get(0);
    
    //Invoke tested method
    quoBVO.setPk_material(pk_material);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getNnum(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=quoBVO.getNnum();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setNnum(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String nnum=(String)dp.get("nnum").get(0);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getNprice(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=quoBVO.getNprice();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setNprice(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String nprice=(String)dp.get("nprice").get(0);
    
    //Invoke tested method
    quoBVO.setNprice(nprice);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getNmmy(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=quoBVO.getNmmy();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setNmmy(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String nmmy=(String)dp.get("nmmy").get(0);
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void getPk_quo(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=quoBVO.getPk_quo();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_quo(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_quo=(String)dp.get("pk_quo").get(0);
    
    //Invoke tested method
    quoBVO.setPk_quo(pk_quo);
