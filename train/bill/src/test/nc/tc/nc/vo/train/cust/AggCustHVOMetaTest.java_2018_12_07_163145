...
import nc.vo.train.cust.AggCustHVOMeta;
import nc.bs.framework.common.NCLocator;
import com.yonyou.uat.framework.BaseTestCase;
public class AggCustHVOMetaTest extends BaseTestCase {
  AggCustHVOMeta aggCustHVOMeta=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggCustHVOMeta=NCLocator.getInstance().lookup(AggCustHVOMeta.class);
  }
