...
public class AggCustHVOTest extends BaseTestCase {
  AggCustHVO aggCustHVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggCustHVO=NCLocator.getInstance().lookup(AggCustHVO.class);
  }
  ...
  public void getParentVO(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    CustHVO retObj=new CustHVO();
    retObj=aggCustHVO.getParentVO();
    ...
    Assert.assertNotNull(retObj.getIndustry());
    Assert.assertEquals(retObj.getIndustry(),"expectValue");
    ...
    Assert.assertNotNull(retObj.getPk_supclass());
    Assert.assertEquals(retObj.getPk_supclass(),"expectValue");
