package nc.tc.nc.vo.train.send;
import org.testng.*;
...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class SendVOTest extends BaseTestCase {
  SendVO sendVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    sendVO=NCLocator.getInstance().lookup(SendVO.class);
  }
  ...
  public void getPk_sendty(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=sendVO.getPk_sendty();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setPk_sendty(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String pk_sendty=(String)dp.get("pk_sendty").get(0);
    
    //Invoke tested method
    sendVO.setPk_sendty(pk_sendty);
  ...
  public void setCreationtime(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    sendVO.setCreationtime(creationtime);
