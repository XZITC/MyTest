...
import nc.vo.train.quo.AggQuoHVOMeta;
import nc.bs.framework.common.NCLocator;
import com.yonyou.uat.framework.BaseTestCase;
public class AggQuoHVOMetaTest extends BaseTestCase {
  AggQuoHVOMeta aggQuoHVOMeta=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    aggQuoHVOMeta=NCLocator.getInstance().lookup(AggQuoHVOMeta.class);
  }
