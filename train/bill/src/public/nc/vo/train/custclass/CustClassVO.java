...
public class CustClassVO extends SuperVO {
	
/**
*主键
*/
public String pk_custty;
/**
*集团
*/
...
/**
* 属性 pk_custty的Getter方法.属性名：主键
*  创建日期:2018-12-5
* @return java.lang.String
*/
public String getPk_custty() {
return this.pk_custty;
} 

/**
* 属性pk_custty的Setter方法.属性名：主键
* 创建日期:2018-12-5
* @param newPk_custty java.lang.String
*/
public void setPk_custty ( String pk_custty) {
this.pk_custty=pk_custty;
} 
...
/**
* 属性parent的Setter方法.属性名：上级客户分类
* 创建日期:2018-12-5
* @param newParent nc.vo.train.custclass.CustClassVO
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("train.CustClassVO");
    }
   }
